...
namespace Wcjj.Net.Bugz.Controllers
{
    public class PrioritiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PriorityId,PriorityPrecedence,Name,Description")] Priority priority)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PriorityId,PriorityPrecedence,Name,Description")] Priority priority)
        {
