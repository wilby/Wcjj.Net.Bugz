...
namespace Wcjj.Net.Bugz.Controllers
{
    public class StatusController : Controller
    {
        ...
        {
            return View(await _context.Status_.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var status = await _context.Status_
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var status = await _context.Status_.FindAsync(id);
            if (status == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (status != null)
            {
                _context.Status_.Remove(status);
            }
        ...
        {
            return _context.Status_.Any(e => e.StatusId == id);
        }
    }
}
